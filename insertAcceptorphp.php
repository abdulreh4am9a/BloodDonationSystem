   <?php
    ...
    require_once("connect.php");
    	...
    	$query="INSERT INTO acceptor (AcceptorId,fName,lName,Gender,BloodGroup,Age,ContactNo) VALUES ('$AcceptorId','$fName','$lName','$Gender','$BloodGroup','$Age','$ContactNo')";
    mysqli_query($con,$query);
    echo"<div >
    		<center><p>
			<h3>Acceptor Added Successfully!</h3><br>
